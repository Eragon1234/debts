...
--> statement-breakpoint
INSERT INTO `__new_passkey_credentials`("user_id", "id", "public_key", "counter", "backed_up", "transports")
SELECT "user_id", "id", "public_key", "counter", "backed_up", "transports"
FROM `passkey_credentials`;--> statement-breakpoint
