ALTER TABLE `tranfers` RENAME TO `transfers`;--> statement-breakpoint
...
INSERT INTO `__new_transfers`("id", "sender_id", "receiver_id", "amount", "description", "date")
SELECT "id", "sender_id", "receiver_id", "amount", "description", "date"
FROM `transfers`;--> statement-breakpoint
